...
export default function Signup({ navigation }) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      <View style={{ flex: 0.4, marginTop: 100 }}>
        <Text style={{ fontSize: 25, textAlign: "center", color: "#004A61", fontSize: 43, fontWeight: "bold", marginTop: 14 }}>Welcome!</Text>
      </View>
      <View style={{ flex: 0.6, alignItems: "center", marginTop: 10 }}>
        <View style={{ position: "absolute", left: 37, zIndex: 1, top: 12 }}><Text ><Icon size={25} name='person' color="#004A61" /></Text></View>
        <TextInput placeholder='User Name' placeholderTextColor="#004A61" onChangeText={(e) => setName(e)} style={{ backgroundColor: "#FCFCFC", fontSize: 16, width: 290, paddingHorizontal: 30, marginBottom: 10, color: "black", paddingTop: 12, borderRadius: 5 }} />
        ...
        <View style={{ flexDirection: "row" }}>
          <TouchableOpacity onPress={ForgetPassword}>
            <Text style={{ fontWeight: "bold", color: "#004A61", marginTop: 5, marginLeft: 160 }}>Forget Password</Text>
          </TouchableOpacity>
        </View>
      </View>
      <View style={{ flex: 0.7, alignItems: "center", marginTop: 10 }}>
        <TouchableOpacity onPress={NextRoute} style={{ backgroundColor: "#004A61", width: 300, borderRadius: 25, marginTop: 10, elevation: 10 }}>
          <Text style={{ color: "white", fontSize: 21, padding: 9, textAlign: "center" }}>START LEARNING</Text>
        </TouchableOpacity>
      </View>
